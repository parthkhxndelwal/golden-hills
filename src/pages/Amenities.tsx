...
import { Activity, Dumbbell, Droplet, Heart, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Activity key={0} />, <Dumbbell key={1} />, <Droplet key={2} />, <Heart key={3} />],
